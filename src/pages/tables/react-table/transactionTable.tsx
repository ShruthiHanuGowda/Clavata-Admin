...
const API_Key4 = 'da2-ukcw7j4dvbh3raqjhjqnlwaw4u'; // API key for second URI
const uri4 = 'https://h3kftouogndclidpvvfoq4k7wy.appsync-api.me-central-1.amazonaws.com/graphql';
